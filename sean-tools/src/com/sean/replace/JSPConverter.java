...
import com.sean.converter.Config;
		...
		if (lines != null) {
			...
			for (String line : lines) {
				try {
					...
					tranLine = tranLine.replaceAll("[Gg][Bb][Kk]", Config
							.getConfig().getConverterTargetCharset());
					tranLine = tranLine.replaceAll("[Gg][Bb]2312", Config
							.getConfig().getConverterTargetCharset());
					tranLine = tranLine.replaceAll("[Gg][Bb]18030", Config
							.getConfig().getConverterTargetCharset());
